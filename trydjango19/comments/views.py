...
def comment_delete(request, id):
    ...
    if obj.user != request.user:
        ...
        # raise Http404 # realistically we need to raise http 403 error and not 404 for permission errors
    ...
    if request.method == "POST":
        ...
        # return render(request, "confirm_delete.html", context, status_code=403) status_code for render method
    context = {
        "object": obj
    }
